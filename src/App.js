...
function App() {
  ...
  const checkIsWinner = () => {
    if(itemArray[0] === itemArray[1] &&
    ...
    else if(itemArray[6] === itemArray[2] &&
      ...
      {
        setWinMessage("Match Drawn, play again")
    }
  }
        ...
        <Col md={6} className="offset-md-3">
          {winMessage ? (
            <div className="mb-2 mt-2">
              ...
              <Button color="info" onClick={reloadGame}>
                Reload
              </Button>
            </div>
          ) : (
          ...
          <div className="grid">
            {itemArray.map((item, index) => (
              <Card color={cardColor(item)} onClick={ () => changeItem(index) }>
